...
pomExtra := <url>https://github.com/InnovaCo/service-control</url>
  <licenses>
    <license>
      <name>BSD-style</name>
  ...
  <scm>
    <url>git@github.com:InnovaCo/service-control.git</url>
    <connection>scm:git:git@github.com:InnovaCo/service-control.git</connection>
  </scm>
  <developers>
    <developer>
      <id>InnovaCo</id>
