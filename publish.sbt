...
pomExtra :=
  <url>https://github.com/hypertino/service-control</url>
    <licenses>
      <license>
        <name>BSD-style</name>
    ...
    <scm>
      <url>git@github.com:hypertino/service-control.git</url>
      <connection>scm:git:git@github.com:hypertino/service-control.git</connection>
    </scm>
    <developers>
      <developer>
        <id>maqdev</id>
